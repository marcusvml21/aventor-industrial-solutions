...
import { Star, Settings, Palette, Users2, CheckCircle, Award, Clock, Cog } from "lucide-react";
const Differentials = () => {
  const differentials = [{
    icon: Star,
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            return <Card key={index} className="bg-gradient-card border-border/50 shadow-card hover:shadow-hover transition-all duration-300 group">
          ...
          <div className="bg-gradient-primary rounded-2xl p-8 md:p-12 text-white">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {features.map((feature, index) => <div key={index} className="flex items-center space-x-3 bg-white/10 backdrop-blur-sm rounded-lg p-4 hover:bg-white/20 transition-colors">
